...
<div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-5 px-4 py-3 mb-5 bg-zinc-50 dark:bg-zinc-700 rounded-2xl shadow-lg">
        ...
        <div class="flex justify-center lg:justify-end">
            <flux:tooltip content="add new student">
                ...
                bg-emerald-500 hover:bg-emerald-700 shadow-xl" wire:click="addStudent">
    ...
    <div>
        @if ($isGridView)
            @livewire('admin.manage-students.manage-students-grid', key($isGridView))
        @else
            @livewire('admin.manage-students.manage-students-table', key($isGridView))
        @endif
    </div>
</div>
