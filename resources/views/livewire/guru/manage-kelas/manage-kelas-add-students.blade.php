@section('header-message')
    <flux:breadcrumbs>
        ...
        <flux:breadcrumbs.item>Add Students</flux:breadcrumbs.item>
    </flux:breadcrumbs>
...
<div>
    <div class="flex gap-2">
        ...
        <flux:heading size="xl" class="font-extrabold" level="1">Add Students to Class: {{ $kelas->name }}</flux:heading>
    </div>
