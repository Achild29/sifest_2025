...
<div>
    ...
    <div class="md:grid grid-cols-3 gap-4 px-4 py-4 leading-10">
        ...
        <div class="p-4 w-full bg-zinc-200 dark:bg-zinc-800 rounded-xl col-span-2 shadow-xl mb-5">
            ...
            <p class="ml-5">Your account role is <span class="font-bold">Siswa</span></p>
        </div>
            ...
            <ul class="divide-y divide-gray-100">
                ...
                <li class="flex justify-between gap-x-6 py-5">
                    <div class="flex min-w-0 gap-x-4">
                        ...
                        <div class="min-w-0 flex-auto">
                            <flux:heading size="xl" class="font-bold text-indigo-500 dark:text-amber-600">NISN / Username</flux:heading>
                ...
                <li class="flex justify-between gap-x-6 py-5">
                    <div class="flex min-w-0 gap-x-4">
                        <div class="flex-none">
                            <flux:icon.book-open variant="solid" class="text-indigo-500 dark:text-amber-600 lg:size-12 size-8" />
                        </div>
                        <div class="min-w-0 flex-auto">
                ...
                <li class="flex justify-between gap-x-6 py-5">
                    <div class="flex min-w-0 gap-x-4">
                        <div class="flex-none">
                            <flux:icon.qr-code variant="solid" class="text-indigo-500 dark:text-amber-600 lg:size-12 size-8" />
                        </div>
                        <div class="min-w-0 flex-auto">
                            <flux:heading size="xl" class="font-bold text-indigo-500 dark:text-amber-600">Absensi QR-Code</flux:heading>
                ...
                <li class="flex justify-between gap-x-6 py-5">
                    <div class="flex min-w-0 gap-x-4">
                        <div class="flex-none">
                            <flux:icon.users variant="solid" class="text-indigo-500 dark:text-amber-600 lg:size-12 size-8" />
                        </div>
                        <div class="min-w-0 flex-auto">
                            <flux:heading size="xl" class="font-bold text-indigo-500 dark:text-amber-600">Nama Orang Tua / Wali</flux:heading>
                            <div class="flex gap-2">
                ...
                <li class="flex justify-between gap-x-6 py-5">
                    <div class="flex min-w-0 gap-x-4">
                        ...
                        <div class="min-w-0 flex-auto">
                            <flux:heading size="xl" class="font-bold text-indigo-500 dark:text-amber-600">No. Handphone Orang Tua / Wali</flux:heading>
                            <div class="flex gap-2">
    ...
    <livewire:siswa.settings.settings-modal />
</div>
